...
//       final vin = await vinProvider.extractVinFromImage(File(file.path));
...
//   Widget _buildVinActions(bool isScanningVin) {
//     return Row(
//       children: [
//         Expanded(
//           child: OutlinedButton.icon(
//             onPressed:
//             isScanningVin ? null : () => _pickVinImage(ImageSource.camera),
...
//           child: OutlinedButton.icon(
//             onPressed:
//             isScanningVin ? null : () => _pickVinImage(ImageSource.gallery),
...
//     final isScanningVin = vinProvider.isLoading;
...
//               const SizedBox(height: 10),
//               _buildVinActions(isScanningVin),
//               const SizedBox(height: 8),
